        ...
        return(
            <>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <label>
                        Sou:
                        <input type="radio" checked={this.state.profissao == 'programador'} onChange={this.changeRadio} value="programador"/>Programador
                        <input type="radio" checked={this.state.profissao == 'estudante'} onChange={this.changeRadio} value="estudante"/>Estudante
                    </label>
                     <br />
                    <label>
                        <input type="checkbox" checked={this.state.dedico} onChange={this.changeCheckbox} /> Dedico 8 horas semanais a estudos
                    </label>
                    <br/>
                    <label>
